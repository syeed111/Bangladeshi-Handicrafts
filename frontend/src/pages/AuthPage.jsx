...
const AuthPage = () => {
  const { login, signup, logState, toggle_log } = useContext(UserContext);
  ...
  return (
    <div className="flex w-full flex-col border-opacity-50">
      <div name="login" className="flex flex-col justify-center ml-10 mr-10">
      ...
      <div name="signup" className="flex flex-col justify-center ml-10 mr-10">
